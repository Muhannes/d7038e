 ...
 * @author truls
 */
public class GameOverGUI implements ScreenController, PingSessionListener, KeyInputHandler{

    private static final Logger LOGGER = Logger.getLogger(GameOverGUI.class.getName());

    private Screen screen;
    private Nifty nifty;
    private Element winner;
    
    private final List<GameOverGUIListener> listeners;
    
    public GameOverGUI(NiftyJmeDisplay display){
    ...
    public void addLobbyGUIListener(GameOverGUIListener gameGUIListener){
        listeners.add(gameGUIListener);
    }
    
    public void removeLobbyGUIListener(GameOverGUIListener gameGUIListener){
